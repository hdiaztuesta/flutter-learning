...
const cards = <Map<String, dynamic>>[
  {'elevation': 0.0, 'label': 'Elevantion 0'},
  {'elevation': 1.0, 'label': 'Elevantion 1'},
  {'elevation': 2.0, 'label': 'Elevantion 2'},
  {'elevation': 3.0, 'label': 'Elevantion 3'},
  {'elevation': 4.0, 'label': 'Elevantion 4'},
  {'elevation': 5.0, 'label': 'Elevantion 5'},
];
...
class CardsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tarjetas en Flutter + Material 3')),
      body: _CardsView(),
    );
  }
}
...
class _CardType1 extends StatelessWidget {
  /// A simple card with an icon and a label.
  final String label;
